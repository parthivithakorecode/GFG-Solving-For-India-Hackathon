...
public final class b53 {
    @CheckForNull
    /* renamed from: a */
    public static String m6683a(@CheckForNull String str) {
        if (p43.m14841b(str)) {
            return null;
        }
        return str;
    ...
    /* renamed from: b */
    public static String m6684b(@CheckForNull String str, @CheckForNull Object... objArr) {
        int length;
        int length2;
        int indexOf;
        String str2;
    ...
    /* renamed from: c */
    public static String m6685c(@CheckForNull String str) {
        return p43.m14840a(str);
    }

    /* renamed from: d */
    public static boolean m6686d(@CheckForNull String str) {
        return p43.m14841b(str);
    }
}
