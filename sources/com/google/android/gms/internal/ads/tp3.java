...
public enum tp3 {
    ...
    /* renamed from: h0 */
    private static final tp3[] f14995h0 = null;

    /* renamed from: f */
    private final oq3 f15015f;

    /* renamed from: g */
    private final int f15016g;

    /* renamed from: h */
    private final Class<?> f15017h;

    static {
        int i;
        f14995h0 = new tp3[r1];
        for (tp3 tp3 : values()) {
            f14995h0[tp3.f15016g] = tp3;
        }
    }

    private tp3(int i, int i2, oq3 oq3) {
        this.f15016g = i;
        this.f15015f = oq3;
        oq3 oq32 = oq3.VOID;
        int i3 = i2 - 1;
        this.f15017h = (i3 == 1 || i3 == 3) ? oq3.mo9837b() : null;
        if (i2 == 1) {
            oq3.ordinal();
        }
    }
