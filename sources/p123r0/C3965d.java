...
/* renamed from: r0.d */
public class C3965d extends C3963c<C3937b> {
    public C3965d(Context context, C4260a aVar) {
    ...
    public boolean mo15423b(C4108p pVar) {
        return pVar.f22323j.mo14767b() == C3648k.CONNECTED;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: i */
    public boolean mo15424c(C3937b bVar) {
        return Build.VERSION.SDK_INT >= 26 ? !bVar.mo15393a() || !bVar.mo15396d() : !bVar.mo15393a();
    }
}
