...
public class C1193c {
    /* renamed from: a */
    private static Interpolator m4790a(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser) {
        Interpolator fVar;
                ...
                if (next == 2) {
                    ...
                    if (name.equals("linearInterpolator")) {
                        ...
                        if (name.equals("accelerateInterpolator")) {
                            ...
                            fVar = new C1197f(context, asAttributeSet, xmlPullParser);
                        } else {
    ...
    /* renamed from: b */
    public static Interpolator m4791b(Context context, int i) {
        ...
        if (i == 17563663) {
            ...
            Interpolator a = m4790a(context, context.getResources(), context.getTheme(), animation);
            if (animation != null) {
                animation.close();
            }
            return a;
