...
public class C0643d {
    ...
    public static class C0645b {
        ...
        C0645b(C0645b bVar) {
            ...
            float[] fArr = bVar.f1956b;
            this.f1956b = C0643d.m2630c(fArr, 0, fArr.length);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:103:0x0242, code lost:
            r24 = r7;
            m2640c(r25, r9, r8, r3, r4, r5, r6, r15, r22, r23);
            r9 = r9 + r12[r13];
            r8 = r8 + r12[r14];
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:116:0x02f3, code lost:
            m2640c(r25, r11, r15, r3, r4, r5, r6, r7, r8, r9);
            r9 = r12[r13];
            r8 = r12[r14];
         */
        ...
        private static void m2638a(android.graphics.Path r25, float[] r26, char r27, char r28, float[] r29) {
            /*
                r10 = r25
                r11 = r28
                r12 = r29
            ...
            L_0x0242:
                ...
                r11 = r9
                r9 = r23
                m2640c(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9)
                r0 = r12[r13]
                float r9 = r11 + r0
                r0 = r12[r14]
                float r8 = r15 + r0
            ...
            L_0x030a:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.C0643d.C0645b.m2638a(android.graphics.Path, float[], char, char, float[]):void");
        }

        /* renamed from: b */
        private static void m2639b(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            double d10 = d3;
        ...
        /* renamed from: c */
        private static void m2640c(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            float f8 = f;
            float f9 = f3;
            ...
            if (d23 < 0.0d) {
                ...
                m2640c(path, f, f2, f3, f4, f10 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            ...
            double d26 = d2 * d15;
            double d27 = d * d11;
            m2639b(path, (d26 * cos) - (d27 * d21), (d26 * d21) + (d27 * cos), d15, d11, d5, d10, radians, atan2, atan22);
        }

        /* renamed from: e */
        public static void m2641e(C0645b[] bVarArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                m2638a(path, fArr, c, bVarArr[i].f1955a, bVarArr[i].f1956b);
                c = bVarArr[i].f1955a;
            }
        }

        /* renamed from: d */
        public void mo2594d(C0645b bVar, C0645b bVar2, float f) {
            this.f1955a = bVar.f1955a;
            int i = 0;
            while (true) {
                float[] fArr = bVar.f1956b;
                if (i < fArr.length) {
                    this.f1956b[i] = (fArr[i] * (1.0f - f)) + (bVar2.f1956b[i] * f);
                    i++;
                } else {
                    return;
                }
    ...
    /* renamed from: a */
    private static void m2628a(ArrayList<C0645b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0645b(c, fArr));
    }

    /* renamed from: b */
    public static boolean m2629b(C0645b[] bVarArr, C0645b[] bVarArr2) {
        if (bVarArr == null || bVarArr2 == null || bVarArr.length != bVarArr2.length) {
            return false;
        }
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f1955a != bVarArr2[i].f1955a || bVarArr[i].f1956b.length != bVarArr2[i].f1956b.length) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: c */
    static float[] m2630c(float[] fArr, int i, int i2) {
        if (i <= i2) {
    ...
    /* renamed from: d */
    public static C0645b[] m2631d(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (i < str.length()) {
            ...
            if (trim.length() > 0) {
                m2628a(arrayList, trim.charAt(0), m2635h(trim));
            }
            i2 = i3;
            i = i3 + 1;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            m2628a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0645b[]) arrayList.toArray(new C0645b[arrayList.size()]);
    }

    /* renamed from: e */
    public static Path m2632e(String str) {
        Path path = new Path();
        C0645b[] d = m2631d(str);
        if (d == null) {
            return null;
    ...
    /* renamed from: f */
    public static C0645b[] m2633f(C0645b[] bVarArr) {
        if (bVarArr == null) {
            return null;
        }
        C0645b[] bVarArr2 = new C0645b[bVarArr.length];
        for (int i = 0; i < bVarArr.length; i++) {
            bVarArr2[i] = new C0645b(bVarArr[i]);
        }
        return bVarArr2;
    }
    ...
    /* renamed from: g */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void m2634g(java.lang.String r8, int r9, androidx.core.graphics.C0643d.C0644a r10) {
        /*
            r0 = 0
            r10.f1954b = r0
            r1 = r9
        ...
        L_0x003b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.C0643d.m2634g(java.lang.String, int, androidx.core.graphics.d$a):void");
    }

    /* renamed from: h */
    private static float[] m2635h(String str) {
        ...
        try {
            ...
            while (i < length) {
                ...
                i = aVar.f1954b ? i3 : i3 + 1;
            }
            return m2630c(fArr, 0, i2);
    ...
    /* renamed from: i */
    private static int m2636i(String str, int i) {
        while (i < str.length()) {
    ...
    /* renamed from: j */
    public static void m2637j(C0645b[] bVarArr, C0645b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f1955a = bVarArr2[i].f1955a;
            for (int i2 = 0; i2 < bVarArr2[i].f1956b.length; i2++) {
                bVarArr[i].f1956b[i2] = bVarArr2[i].f1956b[i2];
            }
        }
    }
}
