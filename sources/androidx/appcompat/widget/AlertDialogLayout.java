...
public class AlertDialogLayout extends C0482m0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: A */
    private boolean m1482A(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C2587f.topPanel) {
                    view = childAt;
                } else if (id == C2587f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C2587f.contentPanel && id != C2587f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m1483j(childCount, i8);
        return true;
    }

    /* renamed from: j */
    private void m1483j(int i, int i2) {
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), 1073741824);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0482m0.C0483a aVar = (C0482m0.C0483a) childAt.getLayoutParams();
                if (aVar.width == -1) {
                    int i4 = aVar.height;
    ...
    /* renamed from: y */
    private void m1484y(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: z */
    private static int m1485z(View view) {
        int s = C0833y.m3363s(view);
        if (s > 0) {
            return s;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1485z(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.m0$a r15 = (androidx.appcompat.widget.C0482m0.C0483a) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.view.C0833y.m3362r(r17)
            int r2 = androidx.core.view.C0782e.m3108a(r2, r3)
            r2 = r2 & 7
            r3 = 1
