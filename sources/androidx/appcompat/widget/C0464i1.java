...
public class C0464i1 extends C0513r0 {

    /* renamed from: c */
    private static boolean f1471c = false;

    /* renamed from: b */
    private final WeakReference<Context> f1472b;

    public C0464i1(Context context, Resources resources) {
        super(resources);
        this.f1472b = new WeakReference<>(context);
    }

    /* renamed from: b */
    public static boolean m1910b() {
        return f1471c;
    }

    /* renamed from: c */
    public static boolean m1911c() {
        return m1910b() && Build.VERSION.SDK_INT <= 20;
    }
    ...
    public Drawable getDrawable(int i) {
        Context context = (Context) this.f1472b.get();
        return context != null ? C0504q0.m2077h().mo2271t(context, this, i) : mo2286a(i);
    }
